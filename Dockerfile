...
# COPY --from=build /app/build/hello_world_application.

# # Установим точку входа
# ENTRYPOINT ./hello_world_appication
...
#WORKDIR /build/hello_world_application

#COPY /app/build/hello_world_application/main .

#ENTRYPOINT ["build/hello_world_application/main"]